    ...
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 text-center text-gray-800 z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="glassmorphism rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl bg-white/80 backdrop-blur-md">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-50 to-teal-50 rounded-full px-4 py-2 mb-6 border border-blue-200">
              <Sparkles className="w-4 h-4 text-blue-600" />
              <span className="text-sm font-medium text-blue-700">24/7 Healthcare Services</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight bg-gradient-to-r from-gray-800 via-blue-700 to-indigo-700 bg-clip-text text-transparent break-words hindi-text text-safe">
              {t('hero-title')}
            </h1>
            
            <p className="text-lg md:text-xl lg:text-2xl mb-10 leading-relaxed text-gray-600 max-w-3xl mx-auto break-words hindi-text text-safe">
              {t('hero-subtitle')}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button
                ...
                className="group relative overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 px-8 py-4 rounded-2xl font-semibold text-lg inline-flex items-center justify-center space-x-3 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-blue-500/20 backdrop-blur-sm"
              >
              ...
              <Button
                ...
                variant="outline"
                className="group relative overflow-hidden bg-white/80 backdrop-blur-sm border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-2xl font-semibold text-lg hover:bg-white hover:border-gray-400 transition-all duration-300 transform hover:scale-105 inline-flex items-center justify-center space-x-3 shadow-lg"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 pt-8 border-t border-gray-200">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-indigo-700 mb-1">24/7</div>
                <div className="text-sm font-medium text-gray-700">
                  <span>{t('value-emergency-care')}</span>
                </div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-teal-700 mb-1">5+</div>
                <div className="text-sm font-medium text-gray-700">
